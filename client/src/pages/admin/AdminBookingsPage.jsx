          ...
          <table className="w-full text-sm">
            <thead>
              <tr style={{ background: '#EDF1F5', borderBottom: '1px solid rgba(7,25,46,0.06)' }}>
                ...
                <th className="text-left px-5 py-3 font-bold uppercase tracking-wider text-xs" style={{ color: '#3D4D61' }}>Locataire</th>
                <th className="text-left px-5 py-3 font-bold uppercase tracking-wider text-xs" style={{ color: '#3D4D61' }}>Propriétaire</th>
                <th className="text-left px-5 py-3 font-bold uppercase tracking-wider text-xs" style={{ color: '#3D4D61' }}>Dates</th>
                <th className="text-left px-5 py-3 font-bold uppercase tracking-wider text-xs" style={{ color: '#3D4D61' }}>Montant</th>
                ...
                filtered.map(b => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3">
                      <p style={{ color: '#3D4D61' }}>{b.tenant?.firstName} {b.tenant?.lastName}</p>
                      <p className="text-xs" style={{ color: '#8896A8' }}>{b.tenant?.email}</p>
                    </td>
