      ...
      >
        <div className="container-max">
          ...
          <p className="mt-3 text-sm max-w-xl" style={{ color: 'rgba(255,255,255,0.65)' }}>
            Une vue catalogue des offres de location approuvées par SailingLoc.
          </p>
        </div>
      </section>
      <section className="container-max section-padding">
        <div className="mb-6 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
          ...
          <span className="text-sm" style={{ color: '#64748B' }}>
            {boats.length} offre{boats.length > 1 ? 's' : ''}
          </span>
        </div>
        {loading ? (
          ...
          <div className="bg-white rounded-2xl p-8 text-center text-sm" style={{ color: '#64748B' }}>
