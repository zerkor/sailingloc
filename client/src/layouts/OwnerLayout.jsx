        ...
        >
          <div className="flex items-center gap-3">
            <div
              ...
              style={{ background: '#0E2540', color: '#00C6E0' }}
            >
              {user?.firstName?.charAt(0)}{user?.lastName?.charAt(0)}
            </div>
            <div>
              <p className="text-sm font-semibold" style={{ color: '#07192E' }}>{user?.firstName} {user?.lastName}</p>
              <p className="text-xs" style={{ color: '#8896A8' }}>Propriétaire</p>
            </div>
          </div>
